  ...
  return (
    <li className="flex items-st art items-center gap-4 self-stretch text-Light  text-center  text-base font-normal leading-6">
      ...
      <ul className="flex  flex-col items-start gap-3 whitespace-nowrap">
        <li>
          <h3 className="font-serif text-[20px] lg:text-[32px]  font-bold leading-[26px] tracking-wide uppercase text-[#000E30]">
            {props.title}
          </h3>
        </li>
        <li>
          <p className="text-center  text-[16px] font-normal leading-6 text-[#9AAAD7]">
            {props.text}
          </p>
        </li>
      </ul>
