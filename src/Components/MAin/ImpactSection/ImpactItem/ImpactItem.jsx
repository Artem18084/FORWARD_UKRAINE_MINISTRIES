...
export default function ImpactItem(props) {
  return (
    <div className="flex flex-col items-center">
      <span className='flex items-center justify-center bg-orange-300 rounded-[50%] w-[2rem] h-[2rem] sm:w-[2.5rem] sm:h-[2.5rem] md:w-[3rem] md:h-[3rem] lg:w-[3.5rem] lg:h-[3.5rem] xl:w-[4.5rem] xl:h-[4.5rem]'>
