...
export default function Footer(props) {
  ...
  return (
    <footer className="flex flex-col items-center justify-center bg-dark-blue text-white px-4 md:px-9 xl:px-11 2xl:px-[72px] py-12 gap-52">
  ...
  <li className="md:order-3">
    <ul className="flex gap-4">
      <ContactButton href="https://www.facebook.com/profile.php?id=100080343590994" src={facebookLogo} alt="facebook" />
